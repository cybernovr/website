...
// import { COURSE_REGISTRATION_DATA } from "@/lib/new-reg-data"
...
// // import { Badge } from "@/components/ui/badge"
// // import { CheckCircle, XCircle, Clock, Play, StopCircle, Download } from "lucide-react"
// // import { COURSE_DEREGISTRATION_DATA } from "@/lib/course-deregistration"
...
// //   // Initialize results
// //   useEffect(() => {
// //     const initialResults: RegistrationResult[] = COURSE_DEREGISTRATION_DATA.map(student => ({
// //       userId: student.userId,
// //       email: student.email,
// //       name: student.name,
// //       status: 'pending'
...
// //   const processNextStudent = async () => {
// //     if (currentIndex >= COURSE_DEREGISTRATION_DATA.length) {
// //       setIsProcessing(false)
// //       return
// //     }

// //     const student = COURSE_DEREGISTRATION_DATA[currentIndex]
...
// //     try {
// //       const response = await fetch('/api/lms/deregister-course', {
// //         method: 'PUT',
// //         headers: {
// //           'Content-Type': 'application/json',
// //         },
...
// //   // Process next student when currentIndex changes and isProcessing is true
// //   useEffect(() => {
// //     if (isProcessing && currentIndex < COURSE_DEREGISTRATION_DATA.length) {
// //       const timer = setTimeout(processNextStudent, 500) // 500ms delay between requests
// //       return () => clearTimeout(timer)
// //     } else if (currentIndex >= COURSE_DEREGISTRATION_DATA.length) {
// //       setIsProcessing(false)
// //     }
// //   }, [isProcessing, currentIndex])
...
// //       timestamp: new Date().toISOString(),
// //       summary: {
// //         total: COURSE_DEREGISTRATION_DATA.length,
// //         completed: completed,
// //         failed: failed,
// //         pending: COURSE_DEREGISTRATION_DATA.length - completed - failed
// //       },
// //       results: results
// //     }
...
// //             <h1 className="text-3xl font-bold mb-2">Bulk Course Registration</h1>
// //             <p className="text-xl text-gray-600">
// //               Register {COURSE_DEREGISTRATION_DATA.length} students for {course.title}
// //             </p>
// //           </div>
...
// //                   <div className="flex items-center gap-2">
// //                     <div className="w-3 h-3 bg-gray-400 rounded-full"></div>
// //                     <span>Pending: {COURSE_DEREGISTRATION_DATA.length - completed - failed}</span>
// //                   </div>
// //                 </div>
...
// //                     <div 
// //                       className="bg-cybernovr-purple h-2 rounded-full transition-all duration-300"
// //                       style={{ width: `${(currentIndex / COURSE_DEREGISTRATION_DATA.length) * 100}%` }}
// //                     ></div>
// //                   </div>
// //                   <p className="text-sm text-gray-600 mt-2 text-center">
// //                     Processing {currentIndex} of {COURSE_DEREGISTRATION_DATA.length} students...
// //                   </p>
// //                 </div>
// //               )}
// //             </CardContent>
