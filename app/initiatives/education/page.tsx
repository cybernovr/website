      ...
      <section className="pt-32 pb-16 bg-gradient-to-r from-deep-blue to-electric-blue text-black">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Cybersecurity Education & Training</h1>
            <p className="text-xl  mb-8">
              Building the next generation of cybersecurity professionals through comprehensive education and training programs.
            </p>
          </div>
        </div>
      </section>
